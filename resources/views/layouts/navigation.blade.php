<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @hasanyrole('Admin|Accountant|Super Admin')
                    ...
                    <x-nav-link :href="route('other-incomes.index')" :active="request()->routeIs('other-incomes.*')">
                        {{ __('Other Income') }}
                    </x-nav-link>
                    @endhasanyrole
                    @hasanyrole('Admin|Accountant|Super Admin')
                            ...
                            <x-slot name="trigger">
                                <a href="#"
                                   class="inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium leading-5 transition duration-150 ease-in-out
                                        {{ $settingsActive ? 'border-indigo-400 text-gray-900 focus:outline-none focus:border-indigo-700' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300' }}"
                                   onclick="event.preventDefault();">
                                    <span>Settings</span>
                                    <svg class="ms-1 h-3 w-3 align-middle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/></svg>
                                </a>
                            </x-slot>
                            <x-slot name="content">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('other-incomes.index')" :active="request()->routeIs('other-incomes.*')">
                {{ __('Other Income') }}
            </x-responsive-nav-link>
            @endhasanyrole
            @hasanyrole('Admin|Accountant|Super Admin')
