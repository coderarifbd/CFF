<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Other Income</h2>
    </x-slot>

    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('other-incomes.update', $income) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input list="income-categories" name="category" value="{{ old('category', $income->category) }}" class="mt-1 w-full border rounded px-3 py-2" placeholder="e.g. Donation, Misc Income" required>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="amount" value="{{ old('amount', $income->amount) }}" class="mt-1 w-full border rounded px-3 py-2" required>
                    ...
                    <div class="flex items-center justify-end gap-3">
                        ...
                        <button class="btn px-4 py-2 bg-green-600 text-white rounded">Update</button>
                    </div>
                </form>
            </div>
        </div>
